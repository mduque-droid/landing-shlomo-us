...
const STEPS = [
  { num: 1, dot: 'bg-red-500', text: 'Old server handles all traffic normally' },
  { num: 2, dot: 'bg-amber-500', text: 'New server syncs data in real-time' },
  { num: 3, dot: 'bg-green-500', text: 'Switch traffic. Zero disruption.' },
];

const MigrationModal = ({ isOpen, onClose }) => (
  <Modal isOpen={isOpen} onClose={onClose} floatingClose labelledBy="migration-modal-title">
    <div className="p-8 md:p-12">
      <div className="text-center mb-8">
        <h2 id="migration-modal-title" className="text-3xl font-bold text-slate-900 mb-2">
        ...
        {STEPS.map((step, idx) => (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              <div className={`w-2 h-2 ${step.dot} rounded-full`}></div>
